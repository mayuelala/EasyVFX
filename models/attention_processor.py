...
class Attention(nn.Module):
    ...
    def forward(
        ...
        img_cond_embeds: Optional[torch.Tensor] = None,
        reference_net_cond: Optional[torch.Tensor] = None,
        **cross_attention_kwargs,
        ...
        if hasattr(self.processor, "ip_scale"):
            return self.processor(
                self,
                hidden_states,
                encoder_hidden_states=encoder_hidden_states,
                attention_mask=attention_mask,
                img_cond_embeds=img_cond_embeds,
                **cross_attention_kwargs,
            )
        elif reference_net_cond is not None:
            return self.processor(
                self,
                hidden_states,
                encoder_hidden_states=encoder_hidden_states,
                attention_mask=attention_mask,
                reference_net_cond=reference_net_cond,
                **cross_attention_kwargs,
            )
        else:
            return self.processor(
